...
{    int sockfd, newsockfd, pid, portno = 6663;                                           /**CHANGE PORT NUMBER!!!**/
     socklen_t clilen;
...
{  int n, i, j, k1=1, k2=1, flag=0;
     int a=3, b=1, c=2;													          /**CHANGE MACHINE #!!!**/
	 int portno1 = 6661, portno2 = 6662;                                          /**CHANGE PORT NUMBER!!!**/
	 char hostname1[5], hostname2[5];
	 char str[8][64], meta[16][32];
	 FILE *fp;
	 
	 strcpy(hostname1,"net11");	strcpy(hostname2,"net12");                        /**CHANGE MACHINE NAME!!!**/
	 bzero(str,8*64);
